...
public class LinkTextAndPartialLinkText {
    public static void main(String[] args) throws InterruptedException {
        ...
        // WebElement example1= driver.findElement(By.linkText("Example 1"));
        // ***bu sekilde hata verir textin tamamının girilmesi gerekir
        ...
        // ***partialLinkte testin bir bölümü locate edilebilir ancak (partial) unique bir değer kullanılmalı

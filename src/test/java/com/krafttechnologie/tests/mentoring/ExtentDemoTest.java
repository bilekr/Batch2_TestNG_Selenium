...
public class ExtentDemoTest {
    ...
    public void setUp(){
        ...
        String reportPath=projectPath + "/test-output/report.html"; // this will be created automatically
        ...
        //title in report
        htmlReporter.config().setReportName("Kraft Login Test");

        //set environment information
        report.setSystemInfo("Environment","QA");
        report.setSystemInfo("Browser", ConfigurationReader.get("browser")); // 2. browser C.readerdan gelen key..
        report.setSystemInfo("OS", System.getProperty("os.name")); // bilgisayarın - OS(Operation System) - windows/işletim sistem bilgileri
